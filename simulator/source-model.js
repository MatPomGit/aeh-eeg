...
function draw(m){
 ...
 $('#srcExplain',m).innerHTML=depth<.3?'<b>Płytkie źródło:</b> silniejszy, bardziej skupiony wzorzec.':depth>.7?'<b>Głębokie źródło:</b> słabszy i bardziej rozlany wzorzec.':'<b>Pośrednia głębokość:</b> kompromis między amplitudą a rozlaniem.';
